...
namespace Maze.Common.Collections
{
    ...
    {
        int _numNodes;
        PriorityQueueNode<TPriority, TValue>[] _nodes;
        long _numNodesEverEnqueued;
        readonly Comparison<TPriority> _comparer;
        ...
        public PriorityQueue(int maxNodes, Comparison<TPriority> comparer)
        {
            ...
            _numNodes = 0;
            _nodes = new PriorityQueueNode<TPriority, TValue>[maxNodes + 1];
        ...
        /// O(1)
        /// </summary>
        public PriorityQueueNode<TPriority, TValue> First
        {
            get
            {
                if(_numNodes <= 0)
        ...
        public IEnumerator<PriorityQueueNode<TPriority, TValue>> GetEnumerator()
        {
            IEnumerable<PriorityQueueNode<TPriority, TValue>> e = 
                new ArraySegment<PriorityQueueNode<TPriority, TValue>>(_nodes, 1, _numNodes);
